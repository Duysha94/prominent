<?php
/**
 * Archives — categories, tags, dates, authors, and any registered taxonomy.
 *
 * Identical in shape to index.php on purpose: both are undesigned routes, and
 * an undesigned route should be honest and legible rather than dressed up.
 * The child had neither, so every archive on the site rendered through the
 * parent theme.
 *
