...
| F-2 | S1 | **Founder names wrong throughout.** `Andrey Karakushan` / `Konstantin Lieontiev` in templates, footer, About, JSON-LD `Person` nodes and meta description | Corrected to **Andrii Karakushan** / **Kostiantyn Lieontiev** in all 6 files. Zero occurrences of the old spellings remain |
