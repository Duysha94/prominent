...
function get_header() {
	include $GLOBALS['THEME'] . '/header.php';
}
function wp_footer() {
...
function bloginfo( $w = '' ) { echo 'charset' === $w ? 'utf-8' : 'AK Brand Development Studio'; }
function get_bloginfo( $w = '', $f = '' ) { return 'AK Brand Development Studio'; }
function body_class( $c = '' ) { echo 'class="ak show--footer"'; }
function wp_body_open() {}
function wp_head() { echo '<link rel="stylesheet" href="zeyna-css/plugins.css"><link rel="stylesheet" href="zeyna-css/style.css"><link rel="stylesheet" href="theme/style.css"><link rel="stylesheet" href="theme/assets/css/ak.css">'; }
function wp_nav_menu( $a = array() ) { ak_menu_fallback(); }


function apply_filters( $tag, $value ) { return $value; }
function add_shortcode( $t, $c ) {}
function add_action( $t, $c = null, $p = 10, $a = 1 ) {}
function add_filter( $t, $c = null, $p = 10, $a = 1 ) {}

require $THEME . '/inc/theme-mode.php';
require $THEME . '/inc/chrome.php';
